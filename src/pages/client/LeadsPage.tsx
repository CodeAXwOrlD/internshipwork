...
export default function LeadsPage() {
  ...
  return (
    <div className="relative space-y-6">
      <ComingSoonOverlay
        title="Leads CRM & Contact Hub"
        description="Consolidate, filter, and track all incoming hot leads generated by your voice campaigns and chat widgets."
        features={[
          "Live Dynamic Kanban Pipeline View",
          "Advanced Lead Score & Interest Level Heatmaps",
          "Instant Click-to-Call Telephony Routing",
          "Complete CRM Activity Logs & Call Recordings"
        ]}
      />
